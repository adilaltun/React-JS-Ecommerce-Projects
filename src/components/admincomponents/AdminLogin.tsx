...
function AdminLogin() {
    ...
    const sendFnc = (evt:React.FormEvent) => {
      ...
      if ( email === '' || email!== 'admin@mail.com' ) {
          toast.error('E-mail Empty or Go to customer login page!')
      }else if ( password === '' ) {
        ...
        <div className='row'>
            ...
            <div className='col-sm-4'>
                ...
                <div className='row'>
                        ...
                        <NavLink to={'/home'} className='btn btn-danger btn-end' ><i className="bi bi-house-door"></i> Home Page</NavLink>
                        </div>
                </div>
